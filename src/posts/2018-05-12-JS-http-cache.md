...
#### If-None-Match Header [TODO]



#### If-Modified-Since Header [TODO]



#### If-Range Header [TODO]



#### If-Unmodified-Since Header [TODO]
...
- 客户端发起请求，检查缓存是否命中：
  ...
  - 若请求在缓存中命中，检查缓存是否fresh：
    ...
    - 若stale，则通过在请求中添加`If-None-Match`向服务器请求检查资源是否fresh：
      - 若返回`304 Not Modified`，则缓存reset age，并将缓存资源返回给客户端
